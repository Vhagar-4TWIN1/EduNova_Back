...
exports.askAI = async (req, res) => {
  try {
    ...
    // Role-based prompt
    const systemPrompt = user.role === 'Teacher' ? "You are a teaching assistant. Provide detailed explanations." : "You are a patient tutor. Explain concepts simply.";
...
exports.generateResume = async (req, res) => {
  ...
  try {
    ...
    res.setHeader('Content-Disposition', `attachment; filename="enhanced_resume_${user.name || user._id}.pdf"`);
